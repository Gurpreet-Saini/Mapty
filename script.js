...
class App {
    ...
    _loadMap(position) {
        ...
        console.log(`https://www.google.com/maps/@${latitude},${longitude},13.04z`)
    ...
    _newWorkout(e) {
        ...
        if (type === 'cycling') {
            ...
            if (!validInputs(distance, duration) || !valid(distance, duration, elevation)) return alert("enter a valid input");
